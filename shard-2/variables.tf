...
variable "argo_rollouts_virtual_service_host" {
  type        = string
  description = "The hostname for the clusternet Rollouts virtual service, used for advanced deployment capabilities like canary and blue-green deployments in Kubernetes."
