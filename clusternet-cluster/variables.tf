variable "cluster_name" {
  ...
  default     = "clusternet-control-plane"
}
...
###############################
###     clusternet-CD CONFIGS     ###
###############################

variable "clusternet_cd_virtual_service_host" {
  type        = string
  description = "The hostname for the clusternet cd virtual service, used for advanced deployment capabilities like canary and blue-green deployments in Kubernetes."
  default     = "clusternet-cd.k8s.raj.ninja"
}

variable "clusternet_cd_ingress_internal" {
  type        = bool
...
variable "clusternet_cd_ingress_type" {
  type        = string
  description = ""
  default     = "application"
}
